...
# bill_detail
bill_detail_train = pd.read_csv('../../pcredit/train/bill_detail_train.txt',
                                       header = None)
bill_detail_test = pd.read_csv('../../pcredit/test/bill_detail_test.txt',
                                       header = None)
...
# loan_time
loan_time_train = pd.read_csv('../../pcredit/train/loan_time_train.txt',
                              header = None)
loan_time_test = pd.read_csv('../../pcredit/test/loan_time_test.txt',
                              header = None)
